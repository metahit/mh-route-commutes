...
saveRDS(routes, (file.path(paste0("1_DataCreated/temp/routes_mode",mode,".Rds"))))
#to do: save more properly

####################
# Make LA matrix
####################
routes <- readRDS(file.path(paste0("1_DataCreated/temp/routes_mode",mode,".Rds"))) ##currently a bodge
...
# Save matrix
write_csv(la_mat, file.path(paste0("1_DataCreated/2_lamatrix_mode", mode, ".csv")))
